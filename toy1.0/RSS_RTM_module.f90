...
character(len=200), parameter     :: file_coeffs_wind_isotropic = '/home/berg/src/rss_emis/external_files/finetune_emiss_wind.dat' 

! [MW 2012] Tables 3 + 4
character(len=200), parameter     :: file_coeffs_wind_direction = '/home/berg/src/rss_emis/external_files/fit_emiss_phir_wind.dat' 

! [MW 2012] Tables 8, 9, 10, 11, 12
character(len=200), parameter     :: file_coeffs_sctterm        = '/home/berg/src/rss_emis/external_files/mk_scatterm_table_all.dat' 

! [MW 2012] eq. (15) for fast computation
character(len=200), parameter     :: file_em0_ref_freq_sst      = '/home/berg/src/rss_emis/external_files/em0_ref_freq_sst.dat' 
